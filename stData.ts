...
degreetitle: string;
courseenrolled :any = []
constructor(name:string,department:string,rollno:number,degreetitle:string,){
   super(name,department)
    this.rollno=rollno 
    this.degreetitle=degreetitle
}
course_enrolled(course:any){
...
cgpa:number;
feestatus:string;
constructor(name:string,department:string,rollno:number,degreetitle:string,semester:string,cgpa:number,feestatus:string){
...
class CourseInst{
  courseNames:string;
  instructors:string;
  constructor(courseNames:string,instructors:string){
